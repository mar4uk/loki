...
type SampleStream struct {
	Labels  []github_com_grafana_loki_pkg_logproto.LabelAdapter `protobuf:"bytes,1,rep,name=labels,proto3,customtype=github.com/mar4uk/loki/pkg/logproto.LabelAdapter" json:"metric"`
